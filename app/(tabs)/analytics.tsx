...
export default function AnalyticsScreen() {
  ...
  const chartConfig: AbstractChartConfig = {
    ...
    decimalPlaces: 1,
    color: (opacity = 1) => `rgba(65, 136, 255, ${opacity})`,
        ...
        <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: verticalScale(30) }}>
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statItem}>
                    <Ionicons name="checkmark-done-circle-outline" size={moderateScale(28)} color="#4caf50" />
                    <Text style={styles.statValue}>{completedCount}</Text>
                    <Text style={styles.statLabel}>Sessions</Text>
                </View>
                <View style={styles.statItem}>
                    <Ionicons name="hourglass-outline" size={moderateScale(28)} color="#ff9800" />
                    <Text style={styles.statValue}>{productiveHours}</Text>
                    <Text style={styles.statLabel}>Hours</Text>
                </View>
                <View style={styles.statItem}>
                    <Ionicons name="flame-outline" size={moderateScale(28)} color="#f44336" />
            ...
            <View style={styles.progressContainer}>
                ...
                <View key={date} style={styles.progressItem}>
                    ...
                    <View style={[styles.progressCircle, dailyProgress[date] ? styles.progressDone : styles.progressMissed]}>
                    {dailyProgress[date] ? (
            ...
            <View style={styles.chartContainer}>
                ...
                <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                    <BarChart
                        data={chartData}
                        width={scale(1200)} // Width is for scrollable content, not screen fit
